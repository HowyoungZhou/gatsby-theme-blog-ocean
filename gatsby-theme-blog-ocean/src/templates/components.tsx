...
const components = {
  p: (() => {
    const Paragraph = props => <Typography {...props} style={{ marginTop: 0, marginBottom: 16 }} />;
    return memo(Paragraph);
  })(),
  h1: (() => {
    const H1 = props => <Typography {...props} component="h1" variant="h3" style={{ margin: '16px 0' }} />;
    return memo(H1);
  })(),
  h2: (() => {
    const H2 = props => <Typography {...props} component="h2" variant="h4" style={{ margin: '40px 0 16px' }} />;
    return memo(H2);
  })(),
  h3: (() => {
    const H3 = props => <Typography {...props} component="h3" variant="h5" style={{ margin: '40px 0 16px' }} />;
    return memo(H3);
  })(),
  h4: (() => {
    const H4 = props => <Typography {...props} component="h4" variant="h6" style={{ margin: '32px 0 16px' }} />;
    return memo(H4);
  })(),
  h5: (() => {
    const H5 = props => <Typography {...props} component="h5" variant="subtitle2" style={{ margin: '32px 0 16px' }} />;
    return memo(H5);
  })(),
  h6: (() => {
  ...
  blockquote: (() => {
    const Blockquote = props => {
      ...
      return (
        <Paper style={{ borderLeft: `5px solid ${theme.palette.primary.light}`, padding: '4px 24px', margin: '24px 0' }} {...props} />
      )
    };
